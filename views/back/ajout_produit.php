...
$mail->Username = 'mohamedkhalil.chakroun@esprit.tn';                 // SMTP username
$mail->Password = 'khalil11412658';                           // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to

$mail->setFrom('mohamedkhalil.chakroun@esprit.tn', 'Khalilchakroun');
$cl=new Clients	;
$result=$cl->afficherClients();
    			...
    			<tr>
    				<td class='one-column'>
    					<table width='100%'>
    						<tr>
    							<td class='inner-td'>
    								<p class='h2'>".$_POST['produit_input']."</p>
    								<p class='h2'>".$_POST['prix_input']."Dinars</p>
...
$mail->AddEmbeddedImage('C:/wamp64/www/website_GYM/views/'.$target_dir.$name,'pr');
