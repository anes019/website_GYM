...
<section class="hero-wrap js-fullheight" >
 ...
 <div  class="col-md-5 col-md-offset-3"  style=" top: 70px;left: 30px">
         <a href="back/table_Client" class="btn btn-block btn-warning"><span class="glyphicon glyphicon-arrow-left"></span> GO BACK TO DASHBOARD</a>
          <br>
          <br>
   <form id="register_form" method="POST" action="../core/ajoutadmin.php">
