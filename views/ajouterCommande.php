...
$facture1=new facture($_POST['id'],$_POST['nom_prenom'],$_POST['adresse'],$_POST['region'],$_POST['ville'],$_POST['r1'],$_POST['r2'],$_POST['nom_prod'],$_POST['qte'],$_POST['prix'],$_POST['total']);
...
require 'C:/wamp64/www/website_GYM/views/back/crud_promo/php-mailer-master/PHPMailerAutoload.php';
    			...
    			<tr>
    				<td class='one-column'>
    					<table width='100%'>
    						<tr>
    							<td class='inner-td'>
    								<p class='h2'>".$_POST['nom_prenom']." vous avez une commande de </p>
    								<p class='h2'>".$_POST['nom_prod']."</p>
                                     <img src='cid:pr'  alt='' class='center'>
